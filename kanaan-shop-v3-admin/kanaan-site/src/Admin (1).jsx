...
function ProductPicker({ products, onPick, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center" style={{ background: "rgba(0,0,0,0.5)" }} onClick={onClose}>
...
function TaggableImage({ image, tags, onChangeTags, products }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "4/5", background: "#1A1A1E" }}>
      ...
      {editingIdx != null && (
        <div className="fixed inset-0 z-[80] flex items-end justify-center" style={{ background: "rgba(0,0,0,0.5)" }} onClick={() => setEditingIdx(null)}>
